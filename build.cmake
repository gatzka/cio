...
elseif(CTEST_CONFIGURATION_TYPE STREQUAL "Valgrind")
  ...
  set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "--trace-children=yes --errors-for-leak-kinds=all --show-leak-kinds=all --leak-check=full --error-exitcode=1")
...
if(DEFINED CTEST_ANALYZER)
  ...
  if(ANALYZER_TYPE STREQUAL "scan-build")
    ...
    set(CTEST_CONFIGURE_COMMAND "${CTEST_ANALYZER} ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Coverage ${CTEST_SOURCE_DIRECTORY}")
